...
import { Indicators } from '@/games/tragedy-looper/types';
...
export function IndicatorDisplay({ 
  ...
  return (
    <div ref={containerRef} data-tutorial-id="character-indicators" className={cn("flex items-center gap-2", className)}>
      {/* Goodwill - 友好 */}
