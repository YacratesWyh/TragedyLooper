...
const ROLE_CONFIG: Record<PlayerRole, {
  ...
  mastermind: {
    label: '剧作家',
    icon: '🎭',
    gradient: 'from-timoris/20 via-slate-950 to-timoris/20',
    border: 'border-timoris',
    btnBg: 'bg-timoris',
    btnHover: 'hover:bg-timoris/80',
    textColor: 'text-timoris',
    glowColor: 'shadow-timoris/30',
  },
  protagonist: {
    label: '主人公',
    icon: '🦸',
    ...
    btnBg: 'bg-oblivionis',
    btnHover: 'hover:bg-oblivionis/80',
    textColor: 'text-oblivionis',
    glowColor: 'shadow-oblivionis/30',
  },
};

const PHASE_HINTS: Partial<Record<GamePhase, string>> = {
  mastermind_action: '选最多3张行动牌，面朝下放到角色或地点上。对手看不到你放了什么。',
  protagonist_action: '选最多3张行动牌，面朝下放到角色或地点上。和剧作家的牌一起翻开结算。',
