...
export interface Player {
  ...
  /** 手牌（CardRef[]） */
  hand: CardRef[];
  /** 是否存活；手牌為 0 則 Happy End 暫時退出，手牌僅迷子或迷子+黑暗則 Bad End 自爆退出 */
  alive: boolean;
...
export const CARD_DEFS: CardDef[] = [
  ...
  { id: 6, name: '平交道', type: 'BRIGHT', description: '从牌堆中抽一张卡，此时若抽到[迷子]，则无论你的手牌中有什么牌，都直接进入[BRIGHTADEND]', index_num: 0, extra_round: 2 },
  ...
  { id: 18, name: '坏掉的街道', type: 'DARK', description: '可以将两张及以上[坏掉的街道]一起打出', index_num: 0, extra_round: 0 },
  { id: 19, name: '坏掉的街道', type: 'DARK', description: '可以将两张及以上[坏掉的街道]一起打出', index_num: 0, extra_round: 0 },
  { id: 20, name: '坏掉的街道', type: 'DARK', description: '可以将两张及以上[坏掉的街道]一起打出', index_num: 0, extra_round: 0 },
  { id: 21, name: '坏掉的街道', type: 'DARK', description: '可以将两张及以上[坏掉的街道]一起打出', index_num: 0, extra_round: 0 },
  { id: 22, name: '坏掉的街道', type: 'DARK', description: '可以将两张及以上[坏掉的街道]一起打出', index_num: 0, extra_round: 0 },
